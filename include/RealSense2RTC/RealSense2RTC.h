...
#ifndef REALSENSE2RTC_H
#define REALSENSE2RTC_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  RealSense2RTC(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void RealSense2RTCInit(RTC::Manager* manager);
};

#endif // REALSENSE2RTC_H
